 ...
 */
#ifndef SECD_NRF52840_USB_H
#define SECD_NRF52840_USB_H
...
/* Observable CDC transmit state (for LED diagnostics). */
bool secd_tx_primed(void);   /* usbd_ep_start_write ever returned 0 */
bool secd_tx_done(void);     /* IN transfer ever completed (cdc_in_cb) */
